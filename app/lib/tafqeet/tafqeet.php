...
class Tafqeet
{
    ...
    {
        $xml = simplexml_load_file(realpath(dirname(__FILE__)) . DS . 'ArNumbers.xml');
        ...
        $xml = simplexml_load_file(realpath(dirname(__FILE__)) . DS . 'arab_countries.xml');
...
//
//$obj = new I18N_Arabic_Numbers('Numbers');
//$obj->setFeminine(1);
//$obj->setFormat(1);
//$integer = 2147483647;
//$text = $obj->int2str($integer);
