<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n30 required padding">
            ...
            <input required type="text" name="BankAccountNumber" id="BankAccountNumber" value="<?= $this->showValue('BankAccountNumber', $account) ?>">
        </div>
        ...
        <div class="input_wrapper_other padding n30 select">
            <select required name="BankBranchId">
                ...
                <?php if (false !== $branches): foreach ($branches as $branch): ?>
                    <option <?= $this->selectedIf('BankBranchId', $branch->BankBranchId, $account) ?> value="<?= $branch->BankBranchId ?>"><?= $branch->BankBranchName ?></option>
