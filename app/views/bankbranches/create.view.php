<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n70 border required">
            <label<?= $this->labelFloat('BankBranchName') ?>><?= $text_label_BankBranchName ?> <span class="required">*</span></label>
            <input required type="text" name="BankBranchName" id="BankBranchName" value="<?= $this->showValue('BankBranchName') ?>">
        </div>
