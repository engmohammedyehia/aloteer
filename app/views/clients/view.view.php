<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n50 border">
            ...
            <input disabled type="text" name="name" id="name" maxlength="80" value="<?= $this->showValue('name', $client) ?>">
        </div>
        <div class="input_wrapper_other n30 padding border">
            <label<?= $this->labelFloat('id_type', $client) ?>><?= $text_label_id_type ?></label>
            <label class="radio">
                <input disabled type="radio" name="id_type" id="id_type" <?= $this->radioCheckedIf('id_type', 1, $client) ?> value="1">
                <div class="radio_button"></div>
                <span><?= $text_label_id_type_1 ?></span>
            </label>
            <label class="radio">
                <input disabled type="radio" name="id_type" id="id_type" <?= $this->radioCheckedIf('id_type', 2, $client) ?> value="2">
                <div class="radio_button"></div>
                <span><?= $text_label_id_type_2 ?></span>
            </label>
            <label class="radio">
                <input disabled type="radio" name="id_type" id="id_type" <?= $this->radioCheckedIf('id_type', 3, $client) ?> value="3">
                <div class="radio_button"></div>
                <span><?= $text_label_id_type_3 ?></span>
            </label>
        </div>
        <div class="input_wrapper n20 padding">
            <label<?= $this->labelFloat('id_number', $client) ?>><?= $text_label_id_number ?></label>
            <input disabled data-language="en" type="text" name="id_number" id="id_number" maxlength="15" value="<?= $this->showValue('id_number', $client) ?>">
        </div>
        <div class="input_wrapper n25 padding border">
            <label<?= $this->labelFloat('mobile', $client) ?>><?= $text_label_mobile ?></label>
            <input disabled data-language="en" type="text" name="mobile" id="mobile" value="<?= $this->showValue('mobile', $client) ?>" maxlength="15">
        </div>
        <div class="input_wrapper n25 padding border">
        ...
        <div class="input_wrapper n15 padding">
            <label<?= $this->labelFloat('zip_code', $client) ?>><?= $text_label_zip_code ?></label>
            <input disabled type="text" data-language="en" name="zip_code" id="zip_code" value="<?= $this->showValue('zip_code', $client) ?>" maxlength="8">
        </div>
