<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n50 border">
            <label<?= $this->labelFloat('title') ?>><?= $text_title_label ?> <span class="required">*</span></label>
            <input required type="text" name="title" id="title" maxlength="80" value="<?= $this->showValue('title') ?>">
        </div>
        ...
        <div class="input_wrapper_other required">
            ...
            <textarea required name="content" id="content" cols="30" rows="10"><?= @$_POST['content'] ?></textarea>
        </div>
