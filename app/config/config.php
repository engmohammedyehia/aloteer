...
defined('DATABASE_HOST_NAME')       ? null : define ('DATABASE_HOST_NAME', 'db_container');
defined('DATABASE_USER_NAME')       ? null : define ('DATABASE_USER_NAME', 'root');
defined('DATABASE_PASSWORD')        ? null : define ('DATABASE_PASSWORD', 'rebo');
defined('DATABASE_DB_NAME')         ? null : define ('DATABASE_DB_NAME', 'cheques');
defined('DATABASE_DB_ENCODING')     ? null : define ('DATABASE_DB_ENCODING', 'UTF8');
...
defined('SESSION_NAME')     ? null : define ('SESSION_NAME', '_OTEER_SESSION');
...
// SMS Credntials
define('SMS_USERNAME', '966508808797');
define('SMS_PASSWORD', 'Hemalaya1');